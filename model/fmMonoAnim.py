...
def animate_update(block_count, iq_data, block_size, rf_coeff, audio_coeff):
	...
	ax1.clear()
	fmPlotPSD(ax1, audio_filt, (rf_Fs/rf_decim)/1e3, subfig_height[1], 'Extracted Mono ' + str(block_count) + ')')
...
if __name__ == "__main__":
	...
	audio_coeff = signal.firwin(rf_taps, audio_Fc/(audio_Fs1/2), window=('hann')) # to be changed by you
